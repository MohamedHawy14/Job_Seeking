    ...
    <x-card class="p-8 sm:p-10 max-w-2xl mx-auto mt-16 sm:mt-24 shadow-md">
        <header class="text-center mb-6">
            <h2 class="text-2xl font-bold mb-2 text-slate-800">
                {{ __('main.create_job_title') }}
            </h2>
            <p class="text-slate-500">{{ __('main.create_job_subtitle') }}</p>
        </header>

        <form action="/listings" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
